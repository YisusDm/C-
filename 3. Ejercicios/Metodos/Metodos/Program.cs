...
namespace Metodos
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            switch (opcion)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    //Pedimos el valor de ambos números usando metodos
                    num1Ar = IngresaNumero("Ingresa el primer número: ");
                    num2Ar = IngresaNumero("Ingresa el segundo número: ");
        ...
        // [modificador] [tipo] [identificador] [parámetros]
        static decimal IngresaNumero(String peticion)
        {
            //Varible locar al metodo
            decimal numero;

            //Pedimos al valor segun corresponda
